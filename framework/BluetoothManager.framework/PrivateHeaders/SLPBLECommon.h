...
//    SDC
    ...
    //BM8701_2
    SLPBLEMessagetUniqType_BM8701_2GetDeviceInfo, //BM8701_2获取设备信息
    SLPBLEMessagetUniqType_BM8701_2SetWorkMode, //BM8701_2设置工作模式
    SLPBLEMessagetUniqType_BM8701_2GetWorkMode, //BM8701_2获取工作模式
    SLPBLEMessagetUniqType_BM8701_2UpgradeSummary, //BM8701_2固件升级概要数据
    SLPBLEMessagetUniqType_BM8701_2UpgradeContent, //BM8701_2固件升级明细数据
